...
TEST_CASE("Testing  Book Class") {
    ...
    SECTION("All Data Book Constructors") {
        ...
        Book a2("The Hitchhiker's Guide to the Galaxy|-1979|Douglas Adams");
        REQUIRE(0 == a2.getYear());
        Book a3("Big C++, Late Objects, Enhanced eText|2018|Cay Horstmann");
        REQUIRE("Big C++, Late Objects, Enhanced eText" == a3.getTitle());
        REQUIRE("Cay Horstmann" == a3.getAuthor());
        REQUIRE(2018 == a3.getYear());
        score += 6;
    }
